...
.frequency-domain-page :deep(.el-descriptions.el-descriptions--small) {
  /* 覆蓋 small size 的預設字體大小 */
}
.frequency-domain-page :deep(.el-descriptions.el-descriptions--small .el-descriptions__label) {
  /* 原始: 繼承預設 */
...
.frequency-domain-page :deep(.el-descriptions.el-descriptions--small .el-descriptions__content) {
  /* 原始: 繼承預設 */
