...
.envelope-analysis-page :deep(.el-descriptions.el-descriptions--small) {
  /* 覆蓋 small size 的預設字體大小 */
}
.envelope-analysis-page :deep(.el-descriptions.el-descriptions--small .el-descriptions__label) {
  /* 原始: 16px */
...
.envelope-analysis-page :deep(.el-descriptions.el-descriptions--small .el-descriptions__content) {
  /* 原始: 16px */
...
.envelope-analysis-page :deep(.el-descriptions.el-descriptions--small .el-tag) {
  /* el-tag 內的文字大小調整 */
